...
import { ContentContainer, Indicator, LinkContainer, MenuContainer, MenuItem, MenuText, Sidebar, SidebarContainer, ToggleButton } from './sidebars.styled';
                    ...
                    <MenuItem>
                        {menuSidebar.map((o) => (
                            <div key={o.id.toString()}>
                                <LinkContainer href={o.navigate} isActive={pathname.includes(o.navigate)}>
